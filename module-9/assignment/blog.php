                    ...
                    <div class="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-3">
                        <article class="flex flex-col dark:bg-gray-900">
                            ...
                            <div class="flex flex-col flex-1 p-6">
                                ...
                                <h3 class="flex-1 py-2 text-lg font-semibold leading-snug">Te nulla oportere reprimique
                                    his dolorum</h3>
                            ...
                            <div class="">
                                <a href="blog-detils.php">
                                    <button type="button"
                                        class="px-8 py-3 font-semibold border rounded text-white bg-black">Rede
                                        more</button>
                                </a>
                            </div>
                        </article>
